    ...
    return (
      <>
        ...
        <div className="hidden lg:grid grid-cols-[2.6%_94.05%_3.35%] grid-rows-[minmax(26vh,auto)] border-b-2 border-cream/10">
          <div className="border-r-2 border-cream/10 p-1"><B h="h-2 w-8" /></div>
          ...
          <div className="p-1 pb-2"><B h="h-24 w-3" /></div>
        </div>
        {/* R1 mobile */}
        ...
        <div className="grid grid-cols-[25px_minmax(0,1fr)_25px] lg:grid-cols-[2.6%_94.05%_3.35%] border-b-2 border-cream/10">
          ...
          <div className="p-1"><B h="h-2 w-8" /></div>
        </div>
        {/* R3: list header */}
        ...
        {[0, 1, 2].map((i) => (
          <div key={`d${i}`} className="hidden lg:grid grid-cols-[2.6%_18.81%_75.24%_1fr] border-b-2 border-cream/10">
            ...
            <div className="p-2"><B h="h-4 w-4" /></div>
          </div>
        ))}
        {[0, 1, 2].map((i) => (
      ...
      <>
        ...
        <FeatureBody>
          <div className="mx-auto max-w-4xl">
            ...
            <B h="mt-3 h-10 w-3/4" />
            <B h="mt-1 h-10 w-2/3" />
            <B h="mt-3 h-3 w-full max-w-2xl" />
            <div className="mt-10 grid gap-4 md:grid-cols-3">
              {[0, 1, 2].map((i) => (
                <div key={i} className="border-2 border-cream/10 bg-cream/5 p-5">
                  <B h="h-3 w-20" />
                  <B h="mt-2 h-5 w-3/4" />
                  <B h="mt-2 h-3 w-full" />
                  <B h="mt-2 h-3 w-2/3" />
                  <div className="mt-4 border-t-2 border-cream/10 pt-3 flex items-center justify-between">
                    <B h="h-3 w-28" />
                    <B h="h-3 w-20" />
                  </div>
                </div>
...
export default function Loading() {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex flex-col bg-[#1A3CDB] text-cream overflow-hidden">
