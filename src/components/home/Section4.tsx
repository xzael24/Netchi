...
export function Section4() {
  ...
  return (
    <section className="relative bg-white text-[#1A3CDB] w-full min-h-[100dvh] overflow-hidden">
      <div className="relative z-10 min-h-[100dvh] flex flex-col items-center justify-center px-6 md:px-16 text-center">
